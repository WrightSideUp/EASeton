...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // Custom ScrollBar
    wp_register_style('custom-scrollbar', get_stylesheet_directory_uri() . '/library/css/jquery.mCustomScrollbar.css', array(), '' );
    wp_register_script('custom-scrollbar', get_stylesheet_directory_uri() . '/library/js/jquery.mCustomScrollbar.js', array( 'jquery' ), '', true);
